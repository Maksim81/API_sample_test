...
namespace CatenaDB
{
    ...
    {        
        ...
        [Test, Description ("TC-001 Create signature")]

        public async System.Threading.Tasks.Task CreateSimpleSignature()
        {
        ...
        [Test, Description("TC-002 Creating the new asynsronous signature")]
    ...
    public class ReadSignature
    {
        ...
        [Test, Description("TC-005 Existing signature basic search")]
        ...
        [Test, Description("TC-006 Not existing signature basic search ")]
        public void GetNotExistingSignatureDetails()
        {
            WebClient client = new WebClient();
            client.Headers.Add("user-agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.2; .NET CLR 1.0.3705;)");
            string html = string.Empty;
            string url = "https://tryout-catena-db.guardtime.net/api/v1/signatures?ids=e3f33734-09e5-4d32-b48c-658f2ade6335";
        ...
        [Test, Description("TC-007 Signature search by specific ID ")]
        public void GetExistingSignatureDetailsById()
        {
            WebClient client = new WebClient();
            client.Headers.Add("user-agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.2; .NET CLR 1.0.3705;)");
            string html = string.Empty;
        ...
        [Test, Description("TC-008 Signature search by specific ID ")]
        public void GetExistingSignatureDetailsByCriterias()
        {
            WebClient client = new WebClient();
            client.Headers.Add("user-agent", "Mozilla/4.0 (compatible; MSIE 6.0; Windows NT 5.2; .NET CLR 1.0.3705;)");
            string html = string.Empty;
